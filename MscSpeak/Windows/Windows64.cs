...
namespace MscSpeak.Windows
{
    internal static class Windows64
    {
        ...
        [DllImport("msc_x64", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        ...
        /// <param name="errorCode">错误代码，成功时为0</param>
        /// <returns>成功时返回新会话ID，否则返回NULL和错误代码</returns>
        [DllImport("msc_x64", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Unicode)]
        ...
        [DllImport("msc_x64", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        ...
        [DllImport("msc_x64", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]

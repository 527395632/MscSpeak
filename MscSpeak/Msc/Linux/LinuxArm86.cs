...
namespace MscSpeak.Msc
{
    internal static class LinuxArm86
    {
        ...
        [DllImport("libmsc_arm", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        ...
        /// <param name="errorCode">错误代码，成功时为0</param>
        /// <returns>成功时返回新会话ID，否则返回NULL和错误代码</returns>
        [DllImport("libmsc_arm", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Unicode)]
        ...
        [DllImport("libmsc_arm", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        ...
        [DllImport("libmsc_arm", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// </summary>
        /// <returns>成功时返回0，否则返回错误代码</returns>
        [DllImport("libmsc_arm", CallingConvention = CallingConvention.StdCall)]
        ...
        /// <summary>
        /// 获取libmsc_arm或本地引擎的版本
        /// 获取libmsc_arm或本地引擎的版本信息
        /// </summary>
        /// <param name="verName">版本名称，可以是"libmsc_arm"、"aitalk"、"aisound"、"ivw"</param>
        /// <param name="errorCode">成功时返回0，否则返回错误代码（输出）</param>

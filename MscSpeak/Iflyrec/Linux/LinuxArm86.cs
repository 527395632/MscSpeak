...
{
    internal static class LinuxArm86
    {
        /// <summary>
        /// 开始一个TTS会话
        /// 创建一个用于合成数据的TTS会话
        ...
        [DllImport("libs/linux_arm/msc.so", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        ...
        /// <param name="errorCode">错误代码，成功时为0</param>
        /// <returns>成功时返回新会话ID，否则返回NULL和错误代码</returns>
        [DllImport("libs/linux_arm/msc.so", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Unicode)]
        ...
        /// <summary>
        /// 获取与libs/linux_arm/msc.so相关的参数（宽字符版本）
        /// 参数可以是本地或服务器参数，目前仅支持网络流量参数"upflow"和"downflow"
        /// </summary>
        ...
        /// <summary>
        /// 设置与libs/linux_arm/msc.so相关的参数（宽字符版本）
        /// 参数可以是本地或服务器参数，目前仅支持网络流量参数"upflow"和"downflow"
        /// </summary>
        ...
        [DllImport("libs/linux_arm/msc.so", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        ...
        [DllImport("libs/linux_arm/msc.so", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// </summary>
        /// <returns>成功时返回0，否则返回错误代码</returns>
        [DllImport("libs/linux_arm/msc.so", CallingConvention = CallingConvention.StdCall)]
        ...
        /// <summary>
        /// 追加数据
        /// 向libs/linux_arm/msc.so写入数据，如要上传的数据、搜索文本等
        /// </summary>
        ...
        /// <summary>
        /// 设置libs/linux_arm/msc.so的参数
        /// 设置libs/linux_arm/msc.so的相关参数
        /// </summary>
        ...
        /// <summary>
        /// 获取libs/linux_arm/msc.so的参数
        /// 获取libs/linux_arm/msc.so的相关参数
        /// </summary>
        /// <param name="paramName">参数名称</param>
        ...
        /// <summary>
        /// 获取libs/linux_arm/msc.so或本地引擎的版本
        /// 获取libs/linux_arm/msc.so或本地引擎的版本信息
        /// </summary>
        /// <param name="verName">版本名称，可以是"libs/linux_arm/msc.so"、"aitalk"、"aisound"、"ivw"</param>
        /// <param name="errorCode">成功时返回0，否则返回错误代码（输出）</param>

...
{
    internal static class Windows64
    {
        /// <summary>
        /// 开始一个TTS会话
        /// 创建一个用于合成数据的TTS会话
        ...
        [DllImport(@"libs\win_x64\msc.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Ansi)]
        ...
        /// <param name="errorCode">错误代码，成功时为0</param>
        /// <returns>成功时返回新会话ID，否则返回NULL和错误代码</returns>
        [DllImport(@"libs\win_x64\msc.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Unicode)]
        ...
        [DllImport(@"libs\win_x64\msc.dll", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        ...
        [DllImport(@"libs\win_x64\msc.dll", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// </summary>
        /// <returns>成功时返回0，否则返回错误代码</returns>
        [DllImport(@"libs\win_x64\msc.dll", CallingConvention = CallingConvention.StdCall)]

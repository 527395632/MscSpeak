...
{
    internal static class Windows86
    {
        /// <summary>
        /// 开始一个TTS会话
        /// 创建一个用于合成数据的TTS会话
        ...
        /// <param name="errorCode">错误代码，成功时为0</param>
        /// <returns>成功时返回新会话ID，否则返回NULL和错误代码</returns>
        [DllImport(@"libs\win_x86\msc.dll", CallingConvention = CallingConvention.StdCall, CharSet = CharSet.Unicode)]
        ...
        [DllImport(@"libs\win_x86\msc.dll", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Unicode)]
        ...
        [DllImport(@"libs\win_x86\msc.dll", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        /// </summary>
        /// <returns>成功时返回0，否则返回错误代码</returns>
        [DllImport(@"libs\win_x86\msc.dll", CallingConvention = CallingConvention.StdCall)]
        ...
        /// 获取MSC或本地引擎的版本信息
        /// </summary>
        /// <param name="verName">版本名称，可以是@"libs\win_x86\msc.dll"、"aitalk"、"aisound"、"ivw"</param>
        /// <param name="errorCode">成功时返回0，否则返回错误代码（输出）</param>
